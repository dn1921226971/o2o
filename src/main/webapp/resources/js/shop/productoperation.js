$(function(){
	...
	//由于商品添加和编辑使用的同一个页面,该标识符用来标明本次是添加还是编辑操作
	var isEdit = false;
	//如果有productId则为编辑操作
	if (productId) {
		getInfo(productId);
	...
	function getInfo(id) {
		$.getJSON(infoUrl,function(data){
			if (data.success) {
				//从后台返回的JSON中获取product对象的信息,并赋值给表单
